        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="navbar-brand" href="#">CABANG</a>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered" id="myTable">
                            ...
                            <tbody>
                                ...
                                include('../konek.php');
                                $no = 1;
                                $query = mysqli_query($connection, "SELECT * FROM tbl_cabang inner join tbl_perusahaan on tbl_perusahaan.id_perusahaan=tbl_cabang.id_perusahaan");
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="hapus.php?id=<?php echo $row['id_cabang'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                                        </td>
                                    </tr>
