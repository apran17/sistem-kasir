...
$query = "INSERT INTO tb_transaksi (id_kasir, id_member, kode_inv, id_pembayaran, waktu_transaksi, nama_pembeli, total_pembayaran, ppn, diskon) VALUES ('$id_kasir', '$id_member', '$kode_inv', '$id_pembayaran', '$waktu_transaksi', '$nama_pembeli', '$total_pembayaran', '$ppn', '$diskon' )";
